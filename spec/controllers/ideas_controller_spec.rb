  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested idea" do
        ...
        Idea.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => idea.to_param, :idea => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the idea as @idea" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Idea.any_instance.stub(:save).and_return(false)
        put :update, {:id => idea.to_param, :idea => { "title" => "invalid value" }}, valid_session
        assigns(:idea).should eq(idea)
      end
